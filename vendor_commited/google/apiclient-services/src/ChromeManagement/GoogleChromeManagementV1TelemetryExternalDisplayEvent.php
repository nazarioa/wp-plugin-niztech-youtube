...
class GoogleChromeManagementV1TelemetryExternalDisplayEvent extends \Google\Collection
{
  ...
  {
    return $this->externalDisplayData;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(GoogleChromeManagementV1TelemetryExternalDisplayEvent::class, 'Google_Service_ChromeManagement_GoogleChromeManagementV1TelemetryExternalDisplayEvent');
