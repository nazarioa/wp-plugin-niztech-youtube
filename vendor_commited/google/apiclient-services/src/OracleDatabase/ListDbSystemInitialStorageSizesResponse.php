...
class ListDbSystemInitialStorageSizesResponse extends \Google\Collection
{
  ...
  {
    $this->dbSystemInitialStorageSizes = $dbSystemInitialStorageSizes;
  }
  /**
...
class_alias(ListDbSystemInitialStorageSizesResponse::class, 'Google_Service_OracleDatabase_ListDbSystemInitialStorageSizesResponse');
