...
class ProjectsLocationsDataStoresOperations extends \Google\Service\Resource
{
   ...
   * (operations.listProjectsLocationsDataStoresOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsDataStoresOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsDataStoresOperations::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsDataStoresOperations');
