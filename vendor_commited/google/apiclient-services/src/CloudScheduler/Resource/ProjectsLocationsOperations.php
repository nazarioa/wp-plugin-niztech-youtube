 ...
 *   $operations = $cloudschedulerService->projects_locations_operations;
 *  </code>
 */
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_CloudScheduler_Resource_ProjectsLocationsOperations');
