 ...
 *   $operations = $migrationcenterService->projects_locations_operations;
 *  </code>
 */
class ProjectsLocationsOperations extends \Google\Service\Resource
{
  ...
  public function cancel($name, CancelOperationRequest $postBody, $optParams = [])
  {
    ...
    return $this->call('cancel', [$params], MigrationcenterEmpty::class);
  }
  /**
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_MigrationCenterAPI_Resource_ProjectsLocationsOperations');
