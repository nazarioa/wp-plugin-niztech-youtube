 ...
 *   $operations = $loggingService->locations_operations;
 *  </code>
 */
class LocationsOperations extends \Google\Service\Resource
{
   ...
   * (operations.listLocationsOperations)
   *
...
class_alias(LocationsOperations::class, 'Google_Service_Logging_Resource_LocationsOperations');
