 ...
 *   $operations = $loggingService->organizations_locations_operations;
 *  </code>
 */
...
class_alias(OrganizationsLocationsOperations::class, 'Google_Service_Logging_Resource_OrganizationsLocationsOperations');
