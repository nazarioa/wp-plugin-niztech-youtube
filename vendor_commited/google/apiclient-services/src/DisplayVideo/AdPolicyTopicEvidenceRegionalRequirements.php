...
class AdPolicyTopicEvidenceRegionalRequirements extends \Google\Collection
{
  ...
  {
    $this->regionalRequirementsEntries = $regionalRequirementsEntries;
  }
  /**
  ...
  {
    return $this->regionalRequirementsEntries;
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(AdPolicyTopicEvidenceRegionalRequirements::class, 'Google_Service_DisplayVideo_AdPolicyTopicEvidenceRegionalRequirements');
