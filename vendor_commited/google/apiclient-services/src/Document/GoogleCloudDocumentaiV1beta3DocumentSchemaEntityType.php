...
class GoogleCloudDocumentaiV1beta3DocumentSchemaEntityType extends \Google\Collection
{
  ...
  /**
   * @param GoogleCloudDocumentaiV1beta3EntityTypeMetadata
   */
  ...
  /**
   * @param GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeEnumValues
   */
  ...
  /**
   * @param GoogleCloudDocumentaiV1beta3DocumentSchemaEntityTypeProperty[]
   */
