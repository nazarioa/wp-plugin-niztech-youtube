 ...
 *   $operations = $oracledatabaseService->projects_locations_operations;
 *  </code>
 */
class ProjectsLocationsOperations extends \Google\Service\Resource
{
  ...
  public function cancel($name, CancelOperationRequest $postBody, $optParams = [])
  {
    ...
    return $this->call('cancel', [$params], OracledatabaseEmpty::class);
  }
  /**
  ...
  public function delete($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], OracledatabaseEmpty::class);
  }
  /**
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_OracleDatabase_Resource_ProjectsLocationsOperations');
