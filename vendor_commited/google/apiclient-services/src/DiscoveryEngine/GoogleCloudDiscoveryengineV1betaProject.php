...
class GoogleCloudDiscoveryengineV1betaProject extends \Google\Model
{
  ...
  /**
   * @param GoogleCloudDiscoveryengineV1betaProjectCustomerProvidedConfig
   */
  ...
  /**
   * @return GoogleCloudDiscoveryengineV1betaProjectServiceTerms[]
   */
...
class_alias(GoogleCloudDiscoveryengineV1betaProject::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaProject');
