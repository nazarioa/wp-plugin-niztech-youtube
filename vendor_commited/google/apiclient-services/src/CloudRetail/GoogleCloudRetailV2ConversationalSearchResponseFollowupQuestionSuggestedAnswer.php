...
class GoogleCloudRetailV2ConversationalSearchResponseFollowupQuestionSuggestedAnswer extends \Google\Model
{
...
class_alias(GoogleCloudRetailV2ConversationalSearchResponseFollowupQuestionSuggestedAnswer::class, 'Google_Service_CloudRetail_GoogleCloudRetailV2ConversationalSearchResponseFollowupQuestionSuggestedAnswer');
