 ...
 *   $operations = $networkmanagementService->organizations_locations_operations;
 *  </code>
 */
...
class_alias(OrganizationsLocationsOperations::class, 'Google_Service_NetworkManagement_Resource_OrganizationsLocationsOperations');
