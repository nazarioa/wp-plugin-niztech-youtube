 ...
 *   $operations = $contactcenterinsightsService->projects_locations_operations;
 *  </code>
 */
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_Contactcenterinsights_Resource_ProjectsLocationsOperations');
