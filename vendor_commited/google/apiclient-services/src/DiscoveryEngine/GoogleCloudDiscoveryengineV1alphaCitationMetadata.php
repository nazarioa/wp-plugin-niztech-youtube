...
class GoogleCloudDiscoveryengineV1alphaCitationMetadata extends \Google\Collection
{
  ...
  /**
   * @param GoogleCloudDiscoveryengineV1alphaCitation[]
   */
...
class_alias(GoogleCloudDiscoveryengineV1alphaCitationMetadata::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaCitationMetadata');
