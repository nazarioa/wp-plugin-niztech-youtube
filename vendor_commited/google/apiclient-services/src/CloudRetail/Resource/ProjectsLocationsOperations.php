 ...
 *   $operations = $retailService->projects_locations_operations;
 *  </code>
 */
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_CloudRetail_Resource_ProjectsLocationsOperations');
