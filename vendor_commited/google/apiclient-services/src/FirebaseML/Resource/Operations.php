 ...
 * Typical usage is:
 *  <code>
 *   $firebasemlService = new Google\Service\FirebaseML(...);
...
class Operations extends \Google\Service\Resource
{
  ...
  public function cancel($name, CancelOperationRequest $postBody, $optParams = [])
  {
    ...
    return $this->call('cancel', [$params], FirebasemlEmpty::class);
  }
  /**
  ...
  public function delete($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], FirebasemlEmpty::class);
  }
  /**
...
class_alias(Operations::class, 'Google_Service_FirebaseML_Resource_Operations');
