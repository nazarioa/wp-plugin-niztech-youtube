...
class ProjectsLocationsOperations extends \Google\Service\Resource
{
  ...
  public function cancel($name, $optParams = [])
  {
    ...
    return $this->call('cancel', [$params], DatacatalogEmpty::class);
  }
  /**
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_DataCatalog_Resource_ProjectsLocationsOperations');
