...
class GoogleCloudDocumentaiV1ListSchemasResponse extends \Google\Collection
{
  ...
  /**
   * @param GoogleCloudDocumentaiV1NextSchema[]
   */
...
class_alias(GoogleCloudDocumentaiV1ListSchemasResponse::class, 'Google_Service_Document_GoogleCloudDocumentaiV1ListSchemasResponse');
