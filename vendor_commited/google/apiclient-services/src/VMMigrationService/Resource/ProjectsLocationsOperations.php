...
class ProjectsLocationsOperations extends \Google\Service\Resource
{
  ...
  public function cancel($name, CancelOperationRequest $postBody, $optParams = [])
  {
    ...
    return $this->call('cancel', [$params], VmmigrationEmpty::class);
  }
  /**
  ...
  public function delete($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], VmmigrationEmpty::class);
  }
  /**
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_VMMigrationService_Resource_ProjectsLocationsOperations');
