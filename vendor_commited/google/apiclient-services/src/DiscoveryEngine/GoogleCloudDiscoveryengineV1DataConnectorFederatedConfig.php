...
class GoogleCloudDiscoveryengineV1DataConnectorFederatedConfig extends \Google\Model
{
  /**
   * @var array[]
   */
...
class_alias(GoogleCloudDiscoveryengineV1DataConnectorFederatedConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1DataConnectorFederatedConfig');
