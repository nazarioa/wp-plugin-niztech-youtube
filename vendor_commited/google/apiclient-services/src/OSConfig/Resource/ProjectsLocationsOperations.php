 ...
 *   $operations = $osconfigService->projects_locations_operations;
 *  </code>
 */
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_OSConfig_Resource_ProjectsLocationsOperations');
