...
class GoogleCloudDiscoveryengineV1alphaAssistantContent extends \Google\Model
{
  ...
  /**
   * @param GoogleCloudDiscoveryengineV1alphaAssistantContentCodeExecutionResult
   */
  ...
  /**
   * @param GoogleCloudDiscoveryengineV1alphaAssistantContentExecutableCode
   */
  ...
  /**
   * @param GoogleCloudDiscoveryengineV1alphaAssistantContentFile
   */
  ...
  /**
   * @param GoogleCloudDiscoveryengineV1alphaAssistantContentBlob
   */
