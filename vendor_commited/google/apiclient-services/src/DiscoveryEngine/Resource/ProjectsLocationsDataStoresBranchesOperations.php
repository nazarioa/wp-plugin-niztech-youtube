 ...
 *   $operations = $discoveryengineService->projects_locations_dataStores_branches_operations;
 *  </code>
 */
class ProjectsLocationsDataStoresBranchesOperations extends \Google\Service\Resource
{
  /**
   ...
   * (operations.listProjectsLocationsDataStoresBranchesOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsDataStoresBranchesOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ProjectsLocationsDataStoresBranchesOperations::class, 'Google_Service_DiscoveryEngine_Resource_ProjectsLocationsDataStoresBranchesOperations');
